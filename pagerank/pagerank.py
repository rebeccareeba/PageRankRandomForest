...
"""
def author():
        return 'rpatro6' # replace gburdell3 with your Georgia Tech username.

def gtid():
    return 903287114 # replace with your GT ID number      
...
### Implement your code here
#############################################
                new_scores[target] += scores[source] / self.node_degree.get(source)

            scores = (1 - damping_factor) * node_weights + damping_factor * np.array(new_scores)
                #pass
#############################################
